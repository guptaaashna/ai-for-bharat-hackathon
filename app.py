    ...
    if request.method == "POST":
        ...
        if action == "language":
            ...
            if stress_level == "High Stress":
                wellness_result = "You seem very stressed. Take rest, hydrate, and talk to someone you trust."
            elif stress_level == "Moderate Stress":
                wellness_result = "You are under pressure. Short breaks and light revision will help."
            else:
                wellness_result = "You seem calm and balanced. Keep maintaining this routine."
